...
const Icons = library.add(faPhone, faUser, faBars, faEarthAmericas, faMagnifyingGlass,
    faBarsStaggered, faMountainCity, faHouseChimney, faHouseFire, faHouseFloodWater,
    faIgloo, faHouseLaptop, faBuilding, faHouseTsunami, faFire, faMountainSun, faStar)
